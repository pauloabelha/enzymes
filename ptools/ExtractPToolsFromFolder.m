...
function [ ptools, ptools_maps, ptools_errors, Ps, pcl_filenames, errors ] = ExtractPToolsFromFolder( root_folder, suffix_bkp_file )
    ...
    for i=1:numel(pcl_filenames)
        try            
            ...
            if numel(SQs) == 1
                ...
                [SQs_alt, ERRORS_SQs_alt] = GetRotationSQFits( SQs, Ps{i}.segms );
