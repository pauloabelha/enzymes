function [ gprs, sigmaMs, feat_imps, dims_ixs, train_res ] = RobotTrain( ptools, scores, root_folder, task, suffix ) 
    ...
    while curr_n_dims < prev_n_dims 
        ...
        [ gprs{end+1}, train_res{end+1}.loss_regression, train_res{end+1}.mean_train_error, train_res{end+1}.mean_test_error, train_res{end+1}.ixs_train, train_res{end+1}.ixs_test ] = FitGPR( ptools(:,dims_ixs{end}), scores, 0.25, 0);        
