...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [ dists_closest, ixs_closest, dists, norm_points ] = GetSortedDistsPoints( points, normalise, MAX_EXTRA_MEM )
    ...
    if EXTRA_MEM_REQUIRED > MAX_EXTRA_MEM
        ...
        dists(logical(I)) = Inf;
        clear I;
        dists_closest = zeros(n_points,n_points);
        ixs_closest = zeros(n_points,n_points);
        for i=1:size(points,1)
            [dists_closest(i,:), ixs_closest(i,:)] = sort(dists(i,:));
        end
    end
end