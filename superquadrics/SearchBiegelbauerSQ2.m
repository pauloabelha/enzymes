function [seed_pcls,lambda_o_initial,lambda_o_final,lambda_lowers,lambda_uppers,final_rank_values,seed_points] ...
                = SearchBiegelbauerSQ2(pcl,seed_points,lambda_f,lambda_default,lambda_lower_def,lambda_upper_def,tapering,bending,sorting_mode,gamma1,gamma2,display_mode)           
    ...
    min_n_surrouding_seed_points = 20;    
    %initialize lambdas        
...
%     lambda_o_final = zeros(n_seeds,length(lambda_default)+3);
    ...
    for i=1:n_seeds
        ...
        seed_pcl = getPCLAroundAPoint(pcl,seed_point,seed_radius,min_n_surrouding_seed_points);
        ...
        %fit SQ
        [lambda_o_res,~,~,~,~] = SolverRecoverySQ(seed_pcl,lambda_f,lambda_o,lambda_lower,lambda_upper,tapering,bending);
        %get ranking values        
