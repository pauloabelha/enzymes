...
%added by Paulo Abelha
if isfield(d.vertex,'nx') && isfield(d.vertex,'ny') && isfield(d.vertex,'nz')
    normal = [d.vertex.nx, d.vertex.ny, d.vertex.nz];
else
    normal = [];
end

%added by Paulo Abelha
if isfield(d.vertex,'red') && isfield(d.vertex,'green') && isfield(d.vertex,'blue')
    colours = [d.vertex.red, d.vertex.green, d.vertex.blue];
else
    colours = [];
end
