function [ task, tools, failed_tool_ptool_ixs, all_tool_scores, best_ptool_scores, best_ptools_ixs ] = ReadCalibrationResults( root_folder, FILE_PREFIX, task, dataset_folder, extracted_ptools_filename, backup_file_suffix )
