function [ P ] = AddColourToSegms( P, colours )
    ...
    if ~exist('colours','var')
        colours = [255 0 0; 0 255 0; 0 0 255; 255 255 0; 255 0 255; 0 255 255; 255 0 0; 0 255 0; 0 0 255; 255 255 0; 255 0 255; 0 255 255;
            127 0 0; 0 127 0; 0 0 127; 127 127 0; 127 0 127; 0 127 127; 127 0 0; 0 127 0; 0 0 127; 127 127 0; 127 0 127; 0 127 127];
    end
        colour_segms = [];
        ix_c=1;
