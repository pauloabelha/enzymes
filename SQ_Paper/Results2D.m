...
FONT_SIZE = 40;
D_AXIS_LABEL = 'D';% ['D=' num2str(D_BEG) ':' num2str(D_STEP) ':' num2str(D_END)];
EPS_AXIS_LABEL = '\epsilon';% ['\epsilon=' num2str(EPS_BEG) ':' nummin(a)2str(EPS_STEP) ':' num2str(EPS_END)];
TIME_TARGET_AXIS_LABEL = 't (ms)';% 'Sampling time t (ms)';
